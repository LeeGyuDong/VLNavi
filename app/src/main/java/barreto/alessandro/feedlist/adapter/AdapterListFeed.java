...
public class AdapterListFeed extends RecyclerView.Adapter<AdapterListFeed.MyViewHolder>{
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.setTvName("Line for a name");
        holder.setTvContent( feed.getText() );
        holder.setTvTime( Long.toString(feed.getTime()) );
        holder.setIvAvatar( feed.getPhotoAvatar() );
        holder.setIvContent( "https://firebasestorage.googleapis.com/v0/b/visible-light-navigation.appspot.com/o/radioactive_sign_01.png?alt=media&token=2dbdda27-057e-49e6-b101-feaea48b83ec" );
